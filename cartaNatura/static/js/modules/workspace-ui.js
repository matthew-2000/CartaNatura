...
export function createWorkspaceUi({ elements, panelCopy }) {
  ...
  function restoreAssistantPanelWidth() {
    ...
    setAssistantPanelWidth(storedWidth || 520, { persist: false });
  }
  ...
  function getActivePanelName() {
    ...
    if (elements.assistantPanel.classList.contains("is-open")) return "assistant";
    return null;
  }
  ...
  function syncPanelChrome(activePanelName) {
    ...
    if (copy) {
      ...
      elements.workspacePanelDescription.textContent = copy.description;
    }
