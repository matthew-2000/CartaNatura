...
class AnalyzeSelectionHandler:
    ...
    def handle(
        ...
        assistant_text = build_analysis_reply(
        ...
        return InteractionResponse(
            messages=(InteractionMessage(role="assistant", text=assistant_text),),
            commands=(command,),
            ...
            audio_output_text=assistant_text,
...
class ExplainLastAnalysisHandler:
    ...
    def handle(
        ...
        assistant_text = build_explanation_reply(
        ...
        return InteractionResponse(
            messages=(InteractionMessage(role="assistant", text=assistant_text),),
            commands=(command,),
            ui_hints={"mode": "explain_last_analysis", "llmConfigured": self._llm_provider is not None},
            audio_output_text=assistant_text,
            updated_context=SessionContext(
